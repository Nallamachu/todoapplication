-- Skip this script execution and let application automatically create schema by changing the property
-- spring.jpa.hibernate.ddl-auto=create at very first time. Change the value back to update once schema is created.
